...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden border-b border-cyan-500/20 bg-linear-to-br from-[#061418] to-[#060d10] px-8 py-12">
      ...
      <div className="scan-line pointer-events-none absolute right-0 left-0 h-px bg-linear-to-r from-transparent via-cyan-500/40 to-transparent" />
      ...
      <div className="relative z-10 flex items-center gap-8">
        <div className="relative h-28 w-28 shrink-0">
          ...
          {/* Corner brackets */}
          <span className="absolute -top-0.5 -left-0.5 h-3 w-3 border-t-2 border-l-2 border-cyan-400" />
          <span className="absolute -top-0.5 -right-0.5 h-3 w-3 border-t-2 border-r-2 border-cyan-400" />
          <span className="absolute -bottom-0.5 -left-0.5 h-3 w-3 border-b-2 border-l-2 border-cyan-400" />
          <span className="absolute -right-0.5 -bottom-0.5 h-3 w-3 border-r-2 border-b-2 border-cyan-400" />
        </div>

        <div>
          <p className="mb-1 font-mono text-xs tracking-[3px] text-cyan-400 uppercase">VRChat Profile</p>
          <h1
